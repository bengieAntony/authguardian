      ...
      <div className="container px-4 md:px-6 max-w-7xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-sm font-medium hover:text-secure-600 transition-colors">Features</a>
            <a href="#benefits" className="text-sm font-medium hover:text-secure-600 transition-colors">Benefits</a>
            <a href="#demo" className="text-sm font-medium hover:text-secure-600 transition-colors">Demo</a>
